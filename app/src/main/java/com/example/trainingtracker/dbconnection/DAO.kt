...
interface DAO {
    ...
    ***********************************************************************************************/
    ...
    @Query("SELECT * FROM trainingplanitem") fun getAllTrainingPlanItems(): List<TrainingPlanItem>
    @Query("SELECT * FROM trainingdayitem") fun getAllTrainingDayItems(): List<TrainingDayItem>
    @Query("SELECT * FROM trainingexerciseitem") fun getAllTrainingExerciseItems(): List<TrainingExerciseItem>
    ...
    @Query("SELECT * FROM serieitem") fun getAllSerieItems(): List<SerieItem>

    /***********************************************************************************************
    ******************************************** INSERT ********************************************
    ***********************************************************************************************/
    @Insert fun insertUserItem(item: UserItem)
    @Insert fun insertTrainingPlanItem(item: TrainingPlanItem)
    @Insert fun insertTrainingDayItem(item: TrainingDayItem)
    @Insert fun insertTrainingExerciseItem(item: TrainingExerciseItem)
    @Insert fun insertExerciseItem(item: ExerciseItem)
    @Insert fun insertHistoryItem(item: HistoryItem)
    @Insert fun insertSerieItem(item: SerieItem)

    /***********************************************************************************************
    ******************************************** DELETE ********************************************
    ***********************************************************************************************/
    @Delete fun deleteUserItem(item: UserItem)
    @Delete fun deleteTrainingPlanItem(item: TrainingPlanItem)
    @Delete fun deleteTrainingDayItem(item: TrainingDayItem)
    @Delete fun deleteTrainingExerciseItem(item: TrainingExerciseItem)
    @Delete fun deleteExerciseItem(item: ExerciseItem)
    @Delete fun deleteHistoryItem(item: HistoryItem)
    @Delete fun deleteSerieItem(item: SerieItem)
